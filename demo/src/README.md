Check: readme.pdf and landing2xpageconversion.yaml

In the example project you can already go to the updater script and execute landing2xpageconversion script.
